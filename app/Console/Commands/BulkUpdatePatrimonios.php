...
class BulkUpdatePatrimonios extends Command
{
    ...
    private function normalizeHeader(string $header): string
    {
        ...
        $aliases = [
            'N_PATRIMONIO' => 'NUPATRIMONIO',
            'NUMERO_PATRIMONIO' => 'NUPATRIMONIO',
            'NUMERO_DO_PATRIMONIO' => 'NUPATRIMONIO',
            'PATRIMONIO' => 'NUPATRIMONIO',
            'CONF' => 'FLCONFERIDO',
            'N_OS' => 'NUMOF',
            'NUMERO_OS' => 'NUMOF',
            'CONFERIDO' => 'FLCONFERIDO',
            'VERIFICADO' => 'FLCONFERIDO',
            'DESC' => 'DEPATRIMONIO',
            'DESCRICAO' => 'DEPATRIMONIO',
            'DESCRICAO_OBJETO' => 'DEPATRIMONIO',
            ...
            'PROJ' => 'CDPROJETO',
            'LOCAL' => 'CDLOCAL',
            'LOCAL_FISICO' => 'CDLOCAL',
            'LOCAL_FIS' => 'CDLOCAL',
            'SITUACAO' => 'SITUACAO',
            'STATUS' => 'SITUACAO',
            'SITUACAO_DO_PATRIMONIO' => 'SITUACAO',
            'SIT' => 'SITUACAO',
            'MARCA' => 'MARCA',
            'MARCA_DO_PATRIMONIO' => 'MARCA',
            'MODELO' => 'MODELO',
            'MODELO_DO_PATRIMONIO' => 'MODELO',
            'N_SERIE' => 'NUSERIE',
            'NUMERO_SERIE' => 'NUSERIE',
            'NUMERO_DE_SERIE' => 'NUSERIE',
            'LOCAL_INTERNO' => 'CDLOCALINTERNO',
            'DT_AQUISICAO' => 'DTAQUISICAO',
            'DT_AQUIS' => 'DTAQUISICAO',
            'DATA_AQUISICAO' => 'DTAQUISICAO',
            'DATA_DE_AQUISICAO' => 'DTAQUISICAO',
            'DT_BAIXA' => 'DTBAIXA',
            'DATA_BAIXA' => 'DTBAIXA',
            'DATA_DE_BAIXA' => 'DTBAIXA',
            'DATA_DE_BAIXA_DO_PATRIMONIO' => 'DTBAIXA',
            'DT_GARANTIA' => 'DTGARANTIA',
            'DATA_GARANTIA' => 'DTGARANTIA',
            'DATA_DE_GARANTIA' => 'DTGARANTIA',
            'NUM_OF' => 'NUMOF',
            'NUMERO_OF' => 'NUMOF',
            'PESO' => 'PESO',
            'DIMENSOES' => 'TAMANHO',
            ...
            'DIM' => 'TAMANHO',
            'TAMANHO' => 'TAMANHO',
            'OBSERVACOES' => 'DEHISTORICO',
            'CODIGO_TERMO' => 'NMPLANTA',
            'COD_TERMO' => 'NMPLANTA',
            'MATRICULA_RESPONSAVEL' => 'CDMATRFUNCIONARIO',
            'MAT_RESP' => 'CDMATRFUNCIONARIO',
        ];
