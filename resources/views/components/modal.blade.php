...
<div
  ...
  x-init="$watch('show', value => { if (value) { document.body.classList.add('overflow-y-hidden'); {{ $attributes->has('focusable') ? 'setTimeout(() => firstFocusable().focus(), 50)' : '' }} } else { document.body.classList.remove('overflow-y-hidden'); } })"
  ...
  role="dialog" aria-modal="true" aria-label="Modal" >
