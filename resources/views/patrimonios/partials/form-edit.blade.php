  ...
  <div class="w-full {{ $isModal ? '' : 'sm:px-6 lg:px-8' }}">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
      <div class="{{ $isModal ? 'p-3 sm:p-4' : 'p-4 sm:p-6' }} text-gray-900 dark:text-gray-100">
        <form method="POST" action="{{ route('patrimonios.update', $patrimonio) }}" id="editPatrimonioForm" data-dados-originais='@json($dadosOriginais)' @if($isModal) data-modal-form="edit" @endif>
          @csrf
          @method('PUT')
          @if($isModal)
