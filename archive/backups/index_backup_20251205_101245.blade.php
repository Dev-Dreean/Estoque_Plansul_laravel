      ...
      <div class="w-full px-2 sm:px-6 lg:px-12 max-w-screen-xl mx-auto">
        ...
        <div class="section">
          <div class="section-body max-w-full">
            ...
            {{-- Tabela Moderna com TODAS as colunas visíveis --}}
                ...
                <tr class="tr-hover text-sm cursor-pointer"
                  ...
                  <td class="px-2 py-2">
                    ...
                    <div class="leading-tight">
                      ...
                      <div class="text-[10px] text-gray-600 dark:text-gray-400 truncate max-w-[120px]">{{ $patrimonio->local->LOCAL }}</div>
                    </div>
                    @else
                    <span class="text-gray-400 text-[10px]">—</span>
                    @endif
                  ...
                  {{-- Responsável --}}
                  <td class="px-2 py-2">
                    @if($patrimonio->responsavel)
                    <div class="leading-tight">
                      <span class="font-mono text-xs">{{ $patrimonio->responsavel->CDMATRFUNCIONARIO }}</span>
                      <div class="text-[10px] text-gray-500 dark:text-gray-400 truncate max-w-[110px]">{{ $patrimonio->responsavel->NMFUNCIONARIO }}</div>
                    </div>
                    @else
                    <span class="text-gray-400 text-[10px]">—</span>
                    @endif
                ...
                <tr>
                  <td colspan="16" class="px-6 py-12 text-center">
                    <div class="flex flex-col items-center justify-center text-gray-600 dark:text-gray-400">
                      ...
                      <p class="text-sm">Não há patrimônios disponíveis ou nenhum atende aos filtros aplicados.</p>
                    </div>
                  </td>
                </tr>
                @endforelse
            ...
            {{-- OLD TABLE REMOVED - USANDO COMPONENTE REUTILIZÁVEL --}}
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg z-0 min-w-0" style="display:none;">
              <table class="w-full table-fixed text-[11px] text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead
            ...
            </div> {{-- FIM: div oculto da tabela antiga --}}
